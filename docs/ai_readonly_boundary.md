...
هذا تنفيذ تمت مراجعته واختباره محليًا، ويظل بانتظار النشر والاختبار بمصادقة حساب AI على التجريبي. تبدأ من GitHub `namar_test` عند `0c1a895` في 6 سبتمبر 2026. لا تعني الاختبارات المحلية اكتمال هدف الحساب الحي أو نقل الحارس إلى الأساسي.
