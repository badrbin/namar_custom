...
const assetPath = path.join(root, "namar_custom", "public", "js", "namar_custom_my_followups_navbar.bundle.js");
const cssPath = path.join(root, "namar_custom", "public", "css", "namar_custom_my_followups_navbar.bundle.css");
const hooksPath = path.join(root, "namar_custom", "hooks.py");
...
async function main() {
  ...
  assert.equal(calls[0].method, "namar_custom.followups.api.get_my_followups_counts");
  ...
  assert.match(hooks, /"namar_custom_my_followups_navbar\.bundle\.js"/);
  assert.match(hooks, /"namar_custom_my_followups_navbar\.bundle\.css"/);
  assert.match(hooks, /namar_custom\.comment_mentions\.notify_mentions_on_comment_update/);
  assert.match(hooks, /namar_custom\.mentions\.events\.capture_mentions_on_update/);
