...
(function () {
  ...
  if (!window.__namar_test_loaded_scripts["Material Request Manufacturing Status List"]) {
    window.__namar_test_loaded_scripts["Material Request Manufacturing Status List"] = true;
    // BEGIN legacy Client Script: Material Request Manufacturing Status List
    ...
    // END legacy Client Script: Material Request Manufacturing Status List
  }
})();
