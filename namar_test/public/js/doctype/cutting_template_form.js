...
(function () {
  ...
  if (!window.__namar_test_loaded_scripts["فلتر أصناف النطاقات"]) {
    window.__namar_test_loaded_scripts["فلتر أصناف النطاقات"] = true;
    // BEGIN legacy Client Script: فلتر أصناف النطاقات
    ...
    // END legacy Client Script: فلتر أصناف النطاقات
  }
})();
