...
from namar_test.delivery_components.snapshot_backfill import (
    SNAPSHOT_FIELDS,
...
TEST_APP = "namar_test"
BACKFILL_CONFIRMATION = "NAMAR_TEST_EVENT_SNAPSHOT_BACKFILL_20260813"


def _ensure_test_app() -> None:
    if TEST_APP not in frappe.get_installed_apps():
        frappe.throw("هذا الترحيل مخصص لتطبيق namar_test على الموقع التجريبي فقط")
