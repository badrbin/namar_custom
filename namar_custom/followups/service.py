...
from namar_custom.followups.approval_routing import role_routing
...
def _approval_counts() -> dict[str, Any]:
    if _approval_index_enabled():
        try:
            from namar_custom.followups import approval_index
...
def get_my_followups_counts() -> dict[str, Any]:
    ...
    from namar_custom.mentions import service as mention_service
...
def complete_and_schedule_next(
    ...
    from namar_custom.mentions import events as mention_events
